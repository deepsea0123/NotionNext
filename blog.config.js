...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '程渡言', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '渡一程山水，言一段人间', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-tau-mocha-98.vercel.app/', // 网站地址
